...
public class WeekAdapter extends ArrayAdapter<Week> {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        String frequency = Objects.requireNonNull(getItem(position)).getFrequency();

        week = new Week(subject, teacher, room, time_from, time_to, type, frequency);
        ...
        holder.type.setText(week.getType());
        holder.frequency.setText(week.getFrequency());
